...
public extension Result where Success == Response, Failure == Error {
    ...
    func string(encoding: String.Encoding = .utf8) -> Result<String, Failure> {
        flatMap { response in
