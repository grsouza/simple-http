...
extension HTTPURLResponse {
    static let noop = HTTPURLResponse(url: URL(string: "https://grds.dev")!, statusCode: 200, httpVersion: nil, headerFields: nil)!
    static let failing = HTTPURLResponse(url: URL(string: "https://grds.dev")!, statusCode: 500, httpVersion: nil, headerFields: nil)!
}
