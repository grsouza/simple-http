...
public typealias RequestInterceptor = (_ client: HTTPClient, _ result: Result<Response, Error>) async throws -> Response
...
public final class HTTPClient: HTTPClientProtocol {
    ...
    public init(baseURL: URL, adapters: [RequestAdapter] = Defaults.adapters, interceptors: [RequestInterceptor] = Defaults.interceptors) {
    ...
    public func request(_ endpoint: Endpoint) async throws -> Response {
        ...
        do {
            ...
            let response = Response(endpoint: endpoint, request: request, response: httpResponse, data: data)
